...
def create_disparse_static_nyuv2(net, ratio, criterion, train_loader, num_batches, device, tasks):
    ...
    # net = disparse_prune_static_channel(net, criterion, train_loader, num_batches, keep_ratio, device, tasks)
    return net
...
def create_disparse_pt_nyuv2(net, ratio, criterion, train_loader, num_batches, device, tasks, dest="/data"):
    ...
    net.load_state_dict(torch.load(f"/home/guo/DiSpare/data/baseline/save_model/best_nyuv2_baseline.pth"))
    net = disparse_prune_static(net, criterion, train_loader, num_batches, keep_ratio, device, tasks)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ratio',type=int, help='percentage of sparsity level', default=30)
    parser.add_argument('--dest', default='/home/guo/DiSpare/data/disparse_static/l1save_model', type=str, help='Destination Save Folder.')
